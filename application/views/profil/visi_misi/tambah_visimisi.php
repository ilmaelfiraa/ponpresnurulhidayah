<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('visi_misi') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<div class="col-12 col-md-12 col-lg-12 mb-4">
    <div class="card">
        <form action="<?php echo base_url() . 'visi_misi/tambah'; ?>" method="post">
            <div class="card-header">
                <h5 class="fw-medium">Tambah Visi & Misi</h5>
            </div>
            <div class="card-body">
                <div class="col-md-12 offset-md-12">
                    <div class="form-grup mb-3">
                        <label-sm for="judul_visimisi">Judul Visi & Misi</label-sm>
                        <input type="text" class="form-control form-control-md text-secondary-500" name="judul_visimisi"
                            required>
                    </div>
                    <div class="form-grup mb-3">
                        <label-sm for="isi_visimisi">Isi Visi Misi</label-sm>
                        <textarea name="isi_visimisi" id="Myeditor"
