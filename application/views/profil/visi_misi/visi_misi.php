<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('visi_misi/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<?php
if (isset($_POST['save'])) {
    $isi_visimisi = strip_tags($_POST['isi_visimisi']);
}
?>
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title fw-medium"><?php echo $data->judul_visimisi ?></h5>
            </div>
            ...
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_visimisi) ?>"
...
<?php foreach ($visi_misi as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_visimisi) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('visi_misi/delete/' . $data->id_visimisi) ?>"
