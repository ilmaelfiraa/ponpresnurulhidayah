<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('program_pendidikan/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title fw-medium"><?php echo $data->judul_programpendidikan ?></h5>
            </div>
            ...
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_programpendidikan) ?>"
...
<?php foreach ($program_pendidikan as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_programpendidikan) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('program_pendidikan/delete/' . $data->id_programpendidikan) ?>"
