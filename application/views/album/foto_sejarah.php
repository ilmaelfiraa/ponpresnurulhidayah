<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    <div>
        <h2 class="fw-bold">Foto Sejarah</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb sm-text-rg">
                ...
                <li class="breadcrumb-item">Foto Sejarah</li>
            </ol>
        </nav>
    </div>
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('foto_sejarah/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
                class="bx bx-plus pe-2"></i>Tambah</a>
    </div>
</div>
<?php $this->load->view('messages') ?>
<div class="row">
    <?php foreach ($foto_sejarah as $data) { ?>
        ...
        <div class="card">
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active p-1">
                            <img src="<?php echo base_url('upload/foto_sejarah/' . $data->image) ?>"
            ...
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_fotosejarah) ?>"
...
<?php foreach ($foto_sejarah as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_fotosejarah) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('foto_sejarah/delete/' . $data->id_fotosejarah) ?>"
