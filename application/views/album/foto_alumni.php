<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    <div>
        <h2 class="fw-bold">Foto Alumni</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb sm-text-rg">
                ...
                <li class="breadcrumb-item">Foto Alumni</li>
            </ol>
        </nav>
    </div>
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('foto_alumni/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
        ...
        <div class="card">
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active p-1">
                            <img src="<?php echo base_url('upload/foto_alumni/' . $data->image) ?>"
            ...
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_fotoalumni) ?>"
...
<?php foreach ($foto_alumni as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_fotoalumni) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('foto_alumni/delete/' . $data->id_fotoalumni) ?>"
