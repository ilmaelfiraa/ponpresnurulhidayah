<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('carousel/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<?php
if (isset($_POST['save'])) {
    $judul_carousel = strip_tags($_POST['judul_carousel']);
}
?>
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4 p-3">
                    <img src="<?php echo base_url('upload/carousel/' . $data->image) ?>" class="img-fluid rounded-2"
                        alt="thumbnail-blog">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title fw-bold"><?php echo $data->judul_carousel ?></h5>
                        <p class="card-text text-secondary-500"><?php echo word_limiter($data->paragraf_carousel, 15) ?>
                        </p>
                    </div>
                    <div class="card-footer text-end">
                        <a href="<?php echo base_url('carousel/edit/' . $data->id_carousel) ?>"
                            class="btn btn-warning text-bg-warning-100 border-0 btn-md">Edit</a>
                        <a href="" data-bs-toggle="modal"
                            data-bs-target="#exampleModalConfirm<?php echo ($data->id_carousel) ?>"
...
<?php foreach ($carousel as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_carousel) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('carousel/hapus/' . $data->id_carousel) ?>"
