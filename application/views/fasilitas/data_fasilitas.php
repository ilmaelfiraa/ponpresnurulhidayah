<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('fasilitas_admin/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<?php
if (isset($_POST['save'])) {
    $isi_fasilitas = strip_tags($_POST['isi_fasilitas']);
}
?>
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4 p-3">
                    <img src="<?php echo base_url('upload/fasilitas/' . $data->image) ?>" class="img-fluid rounded-2"
                        alt="thumbnail-blog">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title fw-bold"><?php echo $data->judul_fasilitas ?></h5>
                        <p class="card-text text-secondary-500"><?php echo word_limiter($data->isi_fasilitas, 15) ?></p>
                    </div>
                    <div class="card-footer text-end">
                        <a href="<?php echo base_url('fasilitas_admin/edit/' . $data->id_fasilitas) ?>"
                            class="btn btn-warning text-bg-warning-100 border-0 btn-md">Edit</a>
                        <a href="" data-bs-toggle="modal"
                            data-bs-target="#exampleModalConfirm<?php echo ($data->id_fasilitas) ?>"
...
<?php foreach ($fasilitas as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_fasilitas) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('fasilitas_admin/delete/' . $data->id_fasilitas) ?>"
