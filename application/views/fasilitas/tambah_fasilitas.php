...
<div class="col-12 col-md-12 col-lg-12 mb-4">
    <div class="card">
        <form action="<?php echo base_url() . 'fasilitas_admin/tambah'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="col-md-12 offset-md-12">
                    <div class="form-grup mb-3">
                        ...
                        <input type="text"
                            class="form-control <?php echo form_error('judul_fasilitas') ? 'is-invalid' : '' ?> form-control-md text-secondary-500"
                            name="judul_fasilitas" required>
                    </div>
                    ...
                    <div class="form-grup mb-3">
                        ...
                        <textarea type="text"
                            class="form-control <?php echo form_error('isi_fasilitas') ? 'is-invalid' : '' ?> form-control-sm text-secondary-500"
                            rows="7" name="isi_fasilitas" required></textarea>
                    </div>
