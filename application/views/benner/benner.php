<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    <div>
        <h2 class="fw-bold">Benner</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb sm-text-rg">
                <li class="breadcrumb-item"><a href="index.html" class="text-success-700">Dashboard</a></li>
                <li class="breadcrumb-item">Benner</li>
            </ol>
        </nav>
    </div>
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('benner_tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
        <div class="card p-3">
            <img src="<?php echo base_url('upload/benner/' . $data->image) ?>" class="card-img-thumbnail rounded-2"
                alt="thumbnail-blog">
            <div class="card-body p-3">
            </div>
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal" data-bs-target="#exampleModalConfirm<?php echo ($data->id_benner) ?>"
...
<?php foreach ($benner as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_benner) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('benner/delete/' . $data->id_benner) ?>"
