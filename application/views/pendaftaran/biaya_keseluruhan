<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('biaya_keseluruhan/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="card-title fw-medium">Biaya Keseluruhan Santri Putra</h5>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($data->harga_putra) ?></td>
                        <td>
                            <a href="" data-bs-toggle="modal"
                                data-bs-target="#exampleModalConfirm<?php echo ($data->id_biayakeseluruhan) ?>"
...
<div class="card mb-4">
    <div class="card-header">
        <h5 class="card-title fw-medium">Biaya Keseluruhan Santri Putri</h5>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($data->harga_putri) ?></td>
                        <td>
                            <a href="" data-bs-toggle="modal"
                                data-bs-target="#exampleModalConfirm<?php echo ($data->id_biayakeseluruhan) ?>"
                                class="btn btn-danger text-bg-danger-100 border-0 btn-md">Hapus</a>
...
<?php foreach ($biaya_keseluruhan as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_biayakeseluruhan) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('biaya_keseluruhan/delete/' . $data->id_biayakeseluruhan) ?>"
