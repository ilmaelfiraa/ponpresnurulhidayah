<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('berkas_persyaratan/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<?php
if (isset($_POST['save'])) {
    $isi_berita = strip_tags($_POST['isi_berkaspersyaratan']);
}
?>
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-body text-secondary-500">
                <?php echo $data->isi_berkaspersyaratan ?>
            </div>
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_berkaspersyaratan) ?>"
...
<?php foreach ($berkas_persyaratan as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_berkaspersyaratan) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('berkas_persyaratan/delete/' . $data->id_berkaspersyaratan) ?>"
