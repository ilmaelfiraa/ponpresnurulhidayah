<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    <div>
        <h2 class="fw-bold">File Brosur</h2>
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('file_brosur/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-body text-secondary-500">
                ...
                <i class='bx bxs-file-pdf'></i><?php echo $data->file ?>
            </div>
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_filebrosur) ?>"
...
<?php foreach ($file_brosur as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_filebrosur) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('file_brosur/delete/' . $data->id_filebrosur) ?>"
