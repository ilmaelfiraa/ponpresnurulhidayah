<div class="header__page d-flex align-items-left align-items-md-center flex-column flex-md-row pt-5 mb-4">
    ...
    <div class="ms-md-auto py-2 py-md-0">
        <a href="<?= base_url('pakaian_perlengkapan/tambah') ?>" class="btn text-bg-white btn-md mb-2"><i
...
<?php
if (isset($_POST['save'])) {
    $isi_waktutempat = strip_tags($_POST['isi_pakaianputra']);
}
?>
...
<div class="row">
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title fw-medium">Pakaian Putra</h5>
            </div>
            <div class="card-body text-secondary-500">
                <?php echo $data->isi_pakaianputra ?>
            </div>
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_pakaianperlengkapan) ?>"
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title fw-medium">Perlengkapan Putra</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <td></td>
                            <td>JUMLAH</td>
                            <td><?php echo ($data->total_hargaputra) ?></td>
                            <td></td>
                            <?php } ?>
                        </tbody>
                    </table>
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title fw-medium">Pakaian Putri</h5>
            </div>
            <div class="card-body text-secondary-500">
                <?php echo $data->isi_pakaianputri ?>
            </div>
            <div class="card-footer text-end">
                <a href="" data-bs-toggle="modal"
                    data-bs-target="#exampleModalConfirm<?php echo ($data->id_pakaianperlengkapan) ?>"
    ...
    <div class="col-12 col-md-12 col-lg-12 mb-4">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title fw-medium">Perlengkapan Putri</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <td></td>
                            <td>JUMLAH</td>
                            <td><?php echo ($data->total_hargaputri) ?></td>
                            <td></td>
                            <?php } ?>
                        </tbody>
                    </table>
...
<?php foreach ($pakaian_perlengkapan as $data) { ?>
<!-- Modal confirm-->
<div class="modal fade" id="exampleModalConfirm<?php echo ($data->id_pakaianperlengkapan) ?>" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content custom p-2">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('pakaian_perlengkapan/delete/' . $data->id_pakaianperlengkapan) ?>"
